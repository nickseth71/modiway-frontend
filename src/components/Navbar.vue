  ...
  >
    ...
    <div class="page-width">
      ...
      >
              ...
              <ul class=" ">
                ...
                <li>
                  <button
                    ...
                    :class="{
                      'w-full flex justify-between items-center text-left font-normal': true,
        ...
        <div
          class="flex justify-start p-6 border-t border-[#8C8C8C] border-opacity-45"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
              ...
              <li class="flex justify-start items-start mt-0 gap-5">
                ...
                >
                  ...
                  <li class="relative whitespace-nowrap">
                    ...
                    >
                      <span>Beauty</span>
                      <i class="fa fa-chevron-right text-sm ml-[30px]"></i>
                    </button>
                    <ul
                      v-show="subMenuState.beauty"
                      class="ml-4 pl-4 absolute left-full top-0 border-l border-gray-300"
                    >
                      <li
...
export default {
  data() {
    return {
      ...
      healthAndNutritionItems: [
        "General Nutrition",
        "Sports Nutrition",
        "Weight Management",
        "Accessory",
      ],
      byTypeItems: ["Beauty", "Kitchen"],
    };
  },
  methods: {
    toggleProductMenu() {
