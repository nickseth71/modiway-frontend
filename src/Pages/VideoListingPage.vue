...
<template>
    <section class="page-width px-[15px]">
        <div class="flex lg:justify-center justify-start lg:items-center items-start  flex-row mt-3 ">
            <span class="text-[#727272] text-[8px] lg:text-[12px] font-outfit font-medium hover:underline cursor-pointer">Resources</span>
            <span class="text-[#727272] text-[8px] lg:text-[12px] px-[5px] font-outfit font-light">|</span>
            <span class="text-[#727272] text-[8px] lg:text-[12px] font-outfit font-light">Video Listing</span>
        </div>
